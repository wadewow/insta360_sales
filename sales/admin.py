...
class StoreAdmin(admin.ModelAdmin):
    list_display = ('id', 'store', 'name', 'password', 'phone', 'manager', 'created_time')
...
class ClerkAdmin(admin.ModelAdmin):
    list_display = ('id', 'store_id', 'name', 'password', 'phone', 'created_time', 'update_time', 'base', 'bonus', 'balance', 'promotion')
...
class PromotionAdmin(admin.ModelAdmin):
    list_display = ('id', 'start_time', 'end_time', 'created_time', 'benchmark', 'bonus')
