...
class ShopAdmin(admin.ModelAdmin):
    list_display = ('id', 'business_id', 'code', 'name', 'online', 'province', 'city', 'location', 'exhibition', 'option', 'agent', 'photo','machine_serial', 'remark', 'created_time', 'promotion', 'manager', 'reason')
